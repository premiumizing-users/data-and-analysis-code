...
### choose one of the following depending on the dataset
# create gdp per capita quintile variable for data_3b
...
# create gdp per capita quintile variable for data_2
quantile(data$gdp_p_capita_2017, probs = .2)
quantile(data$gdp_p_capita_2017, probs = .4)
quantile(data$gdp_p_capita_2017, probs = .6)
quantile(data$gdp_p_capita_2017, probs = .8)
...
data$gdp_p_cap_quintiles <- 1
data$gdp_p_cap_quintiles[data$gdp_p_capita_2017>=26647.5 & data$gdp_p_capita_2017<44469.91] <- 2
data$gdp_p_cap_quintiles[data$gdp_p_capita_2017>=44469.91 & data$gdp_p_capita_2017<59531.66] <- 3
data$gdp_p_cap_quintiles[data$gdp_p_capita_2017>=59531.66] <- 4
#data$gdp_p_cap_quintiles[data$gdp_p_capita_2017>=59531.66] <- 5
